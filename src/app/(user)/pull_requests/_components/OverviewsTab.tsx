import { OpenedPRsChart } from '@/app/(user)/pull_requests/_components/OpenedPRsChart'
import { TopContributorsList } from '@/app/(user)/pull_requests/_components/TopContributorsList'
...
import { getPercentTopContributors } from '@/app/(user)/pull_requests/_utils/get-percent-top-contributors'
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Opened PRs</CardTitle>
            <svg
              width="15"
              height="15"
              viewBox="0 0 15 15"
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              Pending PRs{' '}
              <TooltipQuestion>
                <p>Pull requests that are currently open</p>
              </TooltipQuestion>
            </CardTitle>
            <svg
              xmlns="http://www.w3.org/2000/svg"
